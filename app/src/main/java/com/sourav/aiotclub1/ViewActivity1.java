...
public class ViewActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(ViewActivity1.this);
...
loadingDialog.startLoadingDiloag();
        articleRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                loadingDialog.dismissDialog();
                Toast.makeText(ViewActivity1.this, "Failed to load article", Toast.LENGTH_SHORT).show();
            }
        });
    }
}