...
public class Signin extends AppCompatActivity {
    ...
    private void registerUser() {
        ...
        if (!email.toLowerCase().endsWith("@giet.edu")) {
            editTextEmail.setError("Only @giet.edu email allowed");
            Toast.makeText(this, "Please use your college email (example@giet.edu)", Toast.LENGTH_LONG).show();
            loadingDialog.dismissDialog();
            resetButton();
            return;
        }
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Signin.this, "Registration Failed: " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    @Override
    ...
    private void sendLoginNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, channelId)
                .setSmallIcon(R.drawable.ic_11)
                .setContentTitle("✅ Registration Successful:")
                .setContentText("✅ Now You Are Part Of Android And IOT Club.")
