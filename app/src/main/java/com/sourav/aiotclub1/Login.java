...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginsignup.setOnClickListener(v -> startActivity(new Intent(Login.this, Signin.class)));
        forgetpass.setOnClickListener(v -> startActivity(new Intent(Login.this, ForgetPass.class)));
    ...
    private void sendLoginNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, channelId)
                .setSmallIcon(R.drawable.aiotclubimage)
                .setContentTitle("Welcome To AIOT Club")
                .setContentText("✅ Login Successful, Driving innovation through Android and IoT.")
